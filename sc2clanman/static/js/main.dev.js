...
(function ($) {
    ...
    $(document).ready(function() {
        ...
        var headers = { // This is the default header config
            0: {
        ...
        if (userIsAdmin) {
            headers = { // This is the header config for staff and admin users.
                0: {
                    sorter: false // Row number column - filled dynamically
                },
                1: {
        ...
        $.tablesorter.addParser({
            ...
            format: function(s, table, cell) {
                ...
                return parseFloat(leagueWeight + '.' + ('00' + rank).slice(-3));
            },
        ...
        // Winrate tooltips.
        $membersTable.find('tr[data-toggle="tooltip"]').tooltip({
        ...
        // Skype tooltips.
        $membersTable.find('[data-skype][data-toggle="tooltip"]').tooltip({
            // Add a delay to minimise lag while scrolling the table.
            trigger: 'click focus',
            html: true, // We shouldn't be worried about XSS, since django escapes HTML.
            // Generate the title by using the data attributes
        ...
        // Note popovers
        $membersTable.find('.notes[data-toggle="popover"]').popover({
